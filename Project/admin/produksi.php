                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a href="m_customer.php"><i class="fa fa-user"></i>Data Akun</a></li><br>
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            <div class="alert alert-danger text-center" role="alert">
                                ...
                                <span class="alert-message">Lakukan Reload Setiap Masuk Halaman ini, untuk menghindari
                                    terjadinya kesalahan data dan informasi</span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <a href="produksi.php" class="btn btn-primary btn-lg btn-block">
