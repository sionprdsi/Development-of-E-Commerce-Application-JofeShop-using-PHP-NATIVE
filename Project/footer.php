...
<footer class="site-footer">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-6">
                ...
                <p class="text-justify"><b> Jofe Bakery </b> adalah toko online
                    ...
                    <b>Jofe Bakery</b> dan dapatkan akses ke penawaran dan promo <i>eksklusif</i>, serta informasi tentang
                            produk
    ...
    <style>
        .site-footer {
            background: linear-gradient(to bottom right, #5600c2, #355C7D);
            padding: 45px 0 20px;
            font-size: 15px;
            line-height: 24px;
            color: #f2f2f2;
        ...
        .site-footer a {
            color: #f2f2f2;
            /* ubah warna tautan menjadi putih */
        }
